...
- Preserve source IDs, parser labels, cleanup, and per-entrypoint text limits.
- Run `node scripts/mineru-reading-harness.js` for recognition, companion/embedded fallback, failures, context/tool/summary integration, and newly saved HTML results.
